...
<body>
	...
	<h2 align="center">Notification Duplicates</h2>
	<div class="table-responsive">
		<table id="myTable" class="display table">
			<thead>
				<tr>
			...
			<tbody>
				<%
					List<Notification> duplicates = (List<Notification>) sessions.getAttribute("duplicates");
	...
	<form action="modify.do" id="search" method="post">
		...
		<table style="text-align: center;">
			...
			<tr>
				...
				<td>(note: if you wish to delete multiple notifications at

...
<body>
	...
	<h2 align="center">Order Results before insert</h2>
		...
		<table id="myTable" class="display table">
			...
			<tbody>
				<%
					...
					List<Notification> notificationList = (List<Notification>) sessions.getAttribute("listBeforeInsert");
	...
	<h2 align="center">Order results after insert</h2>
	<div class="table-responsive">
		<table id="myTable" class="display table">
			<thead>
				<tr>
			...
			<tbody>
				<%
					List<Notification> duplicates = (List<Notification>) sessions.getAttribute("listAferInsert");

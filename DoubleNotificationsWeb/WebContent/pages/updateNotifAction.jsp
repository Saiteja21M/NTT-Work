...
<body>
	...
	<h2 align="center">Order Results</h2>
		...
		<table style="text-align: center;">
			...
			<tr>
				<td colspan="4" align="center"><label for="column-names">Choose
						...
						<option value="notif_action">Notification Action</option>
						<option value="notif_item_number">Notifi Item Number</option>
						<option value="notif_docdate">Notification Docdate</option>
				</select></td>
			</tr>
			<tr>
				<td>Enter notif item number of the notification you wish to
					update</td>
				<td colspan="4" align="center"><input type="text"
					name="notif_item_number" required></td>
				<td>(note: if you wish to update multiple notifications at
					once, then please enter notif numbers seperated by a comma)</td>
			</tr>
			<tr>

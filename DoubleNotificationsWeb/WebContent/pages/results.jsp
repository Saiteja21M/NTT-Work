...
<body>
	...
	<h4>
		Welcome:
		<%
		String userName = (String) sessions.getAttribute("user");
	%>
		<%=userName.substring(9)%>
	</h4>
	<h2>Order Results</h2>
	...
	<form action="navigate.do" method="post">
		<input type="submit" name="action" value="View Duplicates"> <input
			type="submit" name="action" value="Update Notif_Action"> <input
			type="submit" name="action" value="Delete Notification"> <input
			type="submit" name="action" value="Clear Duplicates"> <input
			type="submit" name="action" value="Insert Notification">
	</form>
	<br>
